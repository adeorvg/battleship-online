...
public class Ship {
	...
	// zmienne wspó³rzêdnych pocz¹tku i koñca statku, mylê ¿e lepiej bêdzie obie wspó³rzêdne traktowaæ jako liczbê
	...
	private int length; //d³ugoæ statku
	
	private boolean ShipAlive; //stan ¿ywego statku (niezatopionego)
	private boolean ShipDead; //stan zatopionego statku
	
	//myla³em nad tym aby statek mia³ liczbê ¿yæ pocz¹tkowo równ¹ d³ugoci i gdy osi¹gnie 0 wtedy siê zatopi
	...
	//funkcja sprawdzaj¹ca czy statek jest poprawny (pod wzglêdem wspó³rzêdnych i ich relacji z d³ugoci¹)
